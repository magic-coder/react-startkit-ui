export default {
  'page.home.title': 'React Startkit UI',
  'page.home.description': 'React Startkit UI 是一套移动端基础组件库',
  ...
  'page.localeProvider.title.number': '数字标逗号：',
  'page.localeProvider.title.price': '价格：',
